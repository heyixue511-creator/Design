...
| 优先级 | 建议处理对象 | 理由 |
|---|---|---|
| A | `Bringing design to software (Terry Winograd, (ed.))` 后续章节：Interface Guidelines、Consumer Spectrum、World Wide Web、Action-Centered Design、Business-Process Mapping | 支撑数字设计、HCI、软件设计、界面设计章节 |
| A | Cross 相关书籍章节 | 支撑设计知识、设计认知与设计学科 |
