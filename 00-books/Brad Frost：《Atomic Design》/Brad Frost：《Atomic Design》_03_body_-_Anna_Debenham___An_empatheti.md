# - Anna Debenham / An empathetic workfow / Testing, testing, 1-2-3 / Speed / In it for the long haul / Style guide challenges / The hard sell / A matter of time / Auxiliary Projects / Maintenance and governance / Audience confusion / Style guide structure / Lack of context / Lacking a clear methodology / In search of an interface design methodology / Chapter 2 Atomic Design Methodology / Taking cues from chemistry / The atomic design methodology / Atoms / Molecules / Templates / CHAMPION STORYTELLING AT THE OLYMPIC GAMES / Advantages of atomic design / The part and the whole / Clean separation between structure and content / What’s in a name? / Atomic design is for user interfaces / Atomic design in theory and in practice / Chapter 3 Tools of th e Trade / Just what exactly is Pattern Lab? / Pattern Lab is... / Pattern Lab isn’t... / Building atomic design systems with Pattern Lab / {{> atom-thumbnail }} / Lorem ipsum dolor sit (37 characters) / {{> organisms-header }} / Working with dynamic data / Articulating pattern variations with pseudo-patterns / dashboard\~admin.json / "isAdmin" : true / Viewport tools for fexible patterns / A look under the hood with code view / Living documentation and annotations / Providing context with pattern lineage / To each their own / Chapter 4 The Atomic Workfow / It’s people! / When to establish a design system / Pitching patterns / Show, don’t tell: the power of interface inventories / Enter the interface inventory. / Conducting an interface audit / Step 1: Round up the troops / Step 2: Prepare for screenshotting / Step 3: Screenshot exercise / What patterns to capture / Timing is everything / Dig deep / Step 4: Present fndings / Step 5: Regroup and establish next steps / Benefts of an interface inventory / Ask forgiveness, not permission / Do it anyways. / (Re)setting expectations / Redefning design / Death to the waterfall / Development is design / An iterative iterative iterative iterative process / Establishing direction / Establishing content and display patterns / Establishing visual direction / The 20-second gut test / Style tiles / Element collages / Front-end prep chef / Stop, collaborate, and listen / Rolling up our sleeves / From concept to complete / {{> organisms-header }} / The role of comps in a post-PSD era / In-browser iteration / Bring it on home / Maintaining Design Systems / Changing minds, once again / What is it we’re making again? / Done and done / - Nathan Curtis / Creating maintainable design systems / Make it offcial / 1: Make a thing / 2: Show that it’s useful / 3: Make it offcial / Establishing a design system team / Design system makers and users / Design system makers / Design system users / Design system team makeup / Make it adaptable / Making changes to patterns / Modifying patterns / Adding patterns / Removing patterns / Make it maintainable / In search of the holy grail / Clearing technical hurdles / The front-end of things / Bridging the markup gap with templating languages / Is your culture holy grail compatible? / Make it cross-disciplinary / Make it approachable / Make it visible / Design system evangelism / Communicating change / Training and support

> Section: body | Source: 05-Result-MD\03-Design-History-replenish-1\02-Books\Brad Frost：《Atomic Design》\Brad Frost：《Atomic Design》\Brad Frost：《Atomic Design》\auto\Brad Frost：《Atomic Design》.md
