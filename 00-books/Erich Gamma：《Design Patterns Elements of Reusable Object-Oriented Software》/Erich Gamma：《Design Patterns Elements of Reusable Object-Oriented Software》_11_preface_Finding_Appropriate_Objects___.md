# Finding Appropriate Objects / Determining Object Granularity / Specifying Object Interfaces / Specifying Object Implementations / Class versus Interface Inheritance / Programming to an Interface, not an Implementation / Putting Reuse Mechanisms to Work / Delegation / Inheritance versus Parameterized Types / Relating Run-Time and Compile-Time Structures / Designing for Change / Application Programs / Toolkits / Frameworks
...
![](images/07d32c0fa29f733ca313e8183f5a1250631c7be49d6ce9bc0cedda9106b9eed0.jpg)
...
![](images/e4b735246949a8106f2b3a42bf08ac54291aa9b4e421558ddbb4378ec7fec52c.jpg)
...
![](images/2a02ebcc8058d85b01d8581ef136b94a7576078d4f70779e31eea00b720479d0.jpg)
...
![](images/3f47f045a6385cd7f93446c139393a926dd4bdff234f33401e5ecca8454c022e.jpg)
...
![](images/2ec7651267d51157bb15945dea56b86af5b614b874d867cbabad16c309feac04.jpg)
...
Although most programming languages don’t support the distinction between interface and implementation inheritance, people make the distinction in practice. Smalltalk programmers usually act as if subclasses were subtypes (though there are some wellknown exceptions [Coo92]); C++ programmers manipulate objects through types defined by abstract classes.
...
Rectangle by keeping a Rectangle instance variable and delegating Rectangle-specific behavior to it. In other words, instead of a Window being a Rectangle, it would have a Rectangle. Window must now forward requests to its Rectangle instance explicitly, whereas before it would have inherited those operations.

The following diagram depicts the Window class delegating its Area operation to a Rectangle instance.

![](images/67113e25063c3271df64df40c8208498c14bf7c04ca505dd8629dd57ef84b8c3.jpg)
...
The main advantage of delegation is that it makes it easy to compose behaviors at runtime and to change the way they’re composed. Our window can become circular at runtime simply by replacing its Rectangle instance with a Circle instance, assuming Rectangle and Circle have the same type.
...
![](images/728f4ac1d1c169e888e3eb2a08fc5a8178b60154ccafee214eba0da004f2c007.jpg)
